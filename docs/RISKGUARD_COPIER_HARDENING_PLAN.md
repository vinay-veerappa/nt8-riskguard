...
>
> `mutate_p2132.py` grew from 9→13 mutants (copier-normalization, population-path breach, resolved-limit, aggregate-firing), **13/13 killed**. Suite **3531/0**. Tests added: `AggregateCapUsesNormalizedNotSumUnderCopies`, `AnAggregateBreachRecordsTheFiring`, `GetAccountSnapshotsFlagsAPerAccountBreach`. Still **NOT YET DEPLOYED**.

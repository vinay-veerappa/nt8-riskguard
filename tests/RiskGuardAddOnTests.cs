...
// NinjaTrader.Core, NinjaTrader.Code and NinjaTrader.NinjaScript) now live in
// tests/TestingStubs.cs. Same compilation unit, same types -- moved so that another
// repo can compile against them without also dragging in the Main() below. See
// P2-27 in docs/RISKGUARD_COPIER_HARDENING_PLAN.md.
